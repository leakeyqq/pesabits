<?php
    ...
    $KEY= 'S1rb4oxKWZvrCTxqQZs2NJb1tVRLwDWkWJylH1hlAqXVqSqOxZQmTmdq2j30689h';
    $SECRET = '6SAWZsyrjZjYMv481cE4rqZ3cLdLPVpB1oCl8jqZlOvZCnnrqwor7GWfV2bkNo2a';
...
/*
    ...
    echo json_encode($response);
    */
    $response = signedRequest('GET', '/sapi/v1/capital/deposit/address', [
      'coin' => 'BTC',
      'network' => 'BSC'
    ]);
    ...
    /*
    $response = signedRequest('GET', '/sapi/v1/capital/config/getall');
    //echo json_encode($response);
    $jsonString = json_encode($response, JSON_PRETTY_PRINT);
    echo "<pre>" . $jsonString . "</pre>";
    */
